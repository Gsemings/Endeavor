...
/// <summary>
/// An object that can be grabbed and thrown by CustomGrabber.
/// </summary>
public class CustomGrabbable : MonoBehaviour
{
    ...
    protected CustomGrabber m_grabbedBy = null;
    ...
    /// <summary>
    /// An offset relative to the CustomGrabber where this object can snap when grabbed.
    /// </summary>
    ...
    /// <summary>
    /// Returns the CustomGrabber currently grabbing this object.
    /// </summary>
    public CustomGrabber grabbedBy
    {
    ...
    /// </summary>
    virtual public void GrabBegin(CustomGrabber hand, Collider grabPoint)
    {
        m_grabbedBy = hand;
